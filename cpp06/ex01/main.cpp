...
/*   Updated: 2023/03/08 15:27:33 by cben-bar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << POOL_GREEN << "====> ser: " << std::hex << ser << std::endl << std::endl;

	des = deserialize(ser);
	std::cout << PASTEL_GREEN << "\tDES MEMORY ADDRESS: " << std::endl << std::endl;
